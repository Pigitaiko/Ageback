...
//        Once published: `npm install @ageback/middleware`.
//        For now this example resolves via the file: dep declared in
//        x402-server/package.json (run npm install from x402-server first).
